      ...
      <div className="mt-10 h-max flex flex-col justify-between">
        {menuList.map((menu) => (
          <Link
            ...
            key={menu.name}
            className={cn(
              "flex gap-2 mb-2 p-3 hover:bg-primary hover:text-white hover:bg-black cursor-pointer rounded-lg items-center",
              path=== menu.path ? "bg-primary text-white bg-black" : "text-gray-600"
            )}
          >
